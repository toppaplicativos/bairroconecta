...
export const foodBusinesses: Business[] = [
  {
    id: 101,
    name: "Sabor do Bairro",
    category: "Restaurantes",
    service: "Comida Brasileira",
    type: 'food',
    logoUrl: "https://placehold.co/100x100.png",
    coverImageUrl: "https://placehold.co/1200x400.png",
    imageUrl: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxicmF6aWxpYW4lMjBmb29kfGVufDB8fHx8MTc1ODAwNDgwMnww&ixlib=rb-4.1.0&q=80&w=400",
    hint: "brazilian food",
    rating: 4.6,
    reviewsCount: 88,
    deliveryTime: "30-45 min",
    deliveryFee: "R$ 5,99",
    promotion: "Prato do dia com 10% de desconto",
    latitude: -23.555,
    longitude: -46.66,
    description: "O melhor da comida caseira brasileira, com ingredientes frescos e muito sabor.",
    phone: "(11) 98888-1111",
    address: "Rua dos Sabores, 10, Pinheiros",
    hours: [{ day: "Todos os dias", time: "11:00 - 22:00" }],
    gallery: [],
    products: [],
    reviews: [],
  },
  {
    ...
    logoUrl: "https://placehold.co/100x100.png",
    coverImageUrl: "https://placehold.co/1200x400.png",
    imageUrl: "https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxwaXp6YXxlbnwwfHx8fDE3NTgwMDUwOTB8MA&ixlib=rb-4.1.0&q=80&w=400",
    hint: "pizza delivery",
    rating: 4.4,
    reviewsCount: 152,
    ...
    latitude: -23.56,
    longitude: -46.65,
    description: "As melhores pizzas com entrega super rápida. Massa fina e crocante, ingredientes selecionados.",
    phone: "(11) 97777-2222",
    address: "Av. Veloz, 200, Vila Madalena",
    hours: [{ day: "Terça a Domingo", time: "18:00 - 23:30" }],
    gallery: [],
    products: [],
    reviews: [],
  },
  {
    ...
    logoUrl: "https://placehold.co/100x100.png",
    coverImageUrl: "https://placehold.co/1200x400.png",
    imageUrl: "https://images.unsplash.com/photo-1571091718767-18b5b1457add?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHxidXJnZXJ8ZW58MHx8fHwxNzU4MDA1MTMwfDA&ixlib=rb-4.1.0&q=80&w=400",
    hint: "delicious burger",
    rating: 4.9,
    reviewsCount: 320,
    deliveryTime: "35-50 min",
    deliveryFee: "R$ 7,50",
    promotion: "Combo do dia por R$ 29,90",
    latitude: -23.558,
    longitude: -46.665,
    description: "Hambúrgueres artesanais feitos com carne 100% angus. Pão brioche e molhos da casa.",
    phone: "(11) 96666-3333",
    address: "Rua do Hambúrguer, 30, Jardins",
    hours: [{ day: "Quarta a Segunda", time: "17:00 - 23:00" }],
    gallery: [],
    products: [],
    reviews: [],
  },
