    ...
    <div className="relative min-h-screen bg-muted/20">
        ...
        <div className="flex justify-between items-center">
          <Badge className="bg-blue-100 text-blue-600 hover:bg-blue-200">
           ...
           <div className="flex items-center gap-1 text-yellow-500">
            ...
            <span className="text-xs text-muted-foreground">({property.numeroAvaliacoes} reviews)</span>
          </div>
        </div>
            ...
            <TabsContent value="about" className="pt-4 space-y-6">
                <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="p-3 bg-muted rounded-lg">
                        ...
                        <p className="text-sm font-semibold mt-1">{property.quarto} Beds</p>
                    </div>
                     <div className="p-3 bg-muted rounded-lg">
                        <Bath className="h-6 w-6 text-primary mx-auto"/>
                        <p className="text-sm font-semibold mt-1">{property.banheiro} Bath</p>
                    </div>
                     <div className="p-3 bg-muted rounded-lg">
                        <Combine className="h-6 w-6 text-primary mx-auto"/>
                        <p className="text-sm font-semibold mt-1">{property.area} sqrt</p>
                    </div>
                </div>

                <div>
                    <h3 className="text-lg font-bold font-headline">Description</h3>
                ...
                <div>
                    <h3 className="text-lg font-bold font-headline">Listing Agent</h3>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-sm border-t flex items-center justify-between gap-4 z-30">
        <div>
          ...
          <p className="text-xl font-bold font-headline text-blue-600">
            ${property.preco} <span className="font-normal text-sm text-muted-foreground">{property.periodo}</span>
          </p>
        </div>
        <Button
          size="lg"
